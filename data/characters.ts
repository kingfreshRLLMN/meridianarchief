...
export const characters: Character[] = [
  {
    ...
    familyStory: [
      ...
      "Voor Bobby vormt de broederschap met Hugo een belangrijk onderdeel van zijn identiteit. Hun gezamenlijke verleden staat voor discipline, loyaliteit en het vermogen om na verlies opnieuw te beginnen. Binnen Meridian is dit beeld voorlopig voornamelijk gebaseerd op Bobby's verhalen en reputatie, omdat Hugo zelf nog niet publiek in de stad is verschenen.",
