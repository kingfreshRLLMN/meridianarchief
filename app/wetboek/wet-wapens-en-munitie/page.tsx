...
export const metadata: Metadata = {
  ...
  description:
    "Wet Wapens en Munitie, verboden wapens, munitie, explosieven en vuurwerk binnen Meridian.",
};

export default function WeaponsLawPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        <header className="border-b border-[#1f2937] pb-8">
          ...
          <p className="mt-5 max-w-3xl leading-8 text-[#9ca3af]">
            Strafbare feiten rond verboden wapens, vuurwapens, munitie,
            explosieven, replica wapens en vuurwerk. Inbeslagname is bij deze feiten
            vrijwel altijd onderdeel van de afhandeling.
          </p>
        </header>

        <div className="mt-8 grid gap-10 lg:grid-cols-[260px_minmax(0,1fr)]">
          <aside className="self-start lg:sticky lg:top-24">
            <LawbookSidebar activeSlug="wet-wapens-en-munitie" />
          ...
          <section className="min-w-0">
            <div className="flex flex-col justify-between gap-4 border-b border-[#c89b45]/35 pb-6 sm:flex-row sm:items-end">
              <div>
                ...
                <p className="mt-3 max-w-3xl leading-7 text-[#9ca3af]">
                  De strafmaat loopt op bij vuurwapens, automatische wapens,
                  explosieven, grote hoeveelheden munitie, handel en gebruik in
                  combinatie met geweld of georganiseerde criminaliteit.
                </p>
              </div>
              <span className="w-fit rounded-md border border-[#c89b45]/35 bg-[#09090b] px-3 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#e0b85a]">
                {weaponsArticles.length} artikelen
              </span>
            </div>
            ...
            <footer className="pt-8 text-sm leading-6 text-[#6b7280]">
              Deze strafmaten zijn gebaseerd op Nederlandse verhoudingen en
              vertaald naar de speelbare schaal van Meridian. Gebruik van een
              wapen bij een ander strafbaar feit kan leiden tot stapeling of
