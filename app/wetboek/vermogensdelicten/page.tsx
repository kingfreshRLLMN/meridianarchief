...
export const metadata: Metadata = {
  ...
  description:
    "Vermogensdelicten, diefstal, overvallen, heling en witwassen binnen Meridian.",
};
      ...
      <div className="mx-auto max-w-7xl">
        <header className="border-b border-[#1f2937] pb-8">
          ...
          <p className="mt-5 max-w-3xl leading-8 text-[#9ca3af]">
            Strafbare feiten waarbij geld, goederen, buit of financieel voordeel
            centraal staan. Schadevergoeding en inbeslagname kunnen naast de
            genoemde straf worden opgelegd.
          </p>
        </header>

        <div className="mt-8 grid gap-10 lg:grid-cols-[260px_minmax(0,1fr)]">
          <aside className="self-start lg:sticky lg:top-24">
            <LawbookSidebar activeSlug="vermogensdelicten" />
          ...
          <section className="min-w-0">
            <div className="flex flex-col justify-between gap-4 border-b border-[#c89b45]/35 pb-6 sm:flex-row sm:items-end">
              <div>
                ...
                <p className="mt-3 max-w-3xl leading-7 text-[#9ca3af]">
                  De strafmaat loopt op met geweld, organisatiegraad, herhaling
                  en de waarde van de buit. Slachtofferschade hoort waar
                  mogelijk te worden hersteld.
                </p>
              </div>
              <span className="w-fit rounded-md border border-[#c89b45]/35 bg-[#09090b] px-3 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#e0b85a]">
                {propertyArticles.length} artikelen
              </span>
            </div>
            ...
            <footer className="pt-8 text-sm leading-6 text-[#6b7280]">
              ...
              vertaald naar de speelbare schaal van Meridian. De waarde van
              buit, gebruikte wapens, letsel en groepsverband kunnen de straf
              verder beïnvloeden.
            </footer>
          </section>
        </div>
